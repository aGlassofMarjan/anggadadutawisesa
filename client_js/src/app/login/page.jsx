...
import { setCurrentUser } from '@/store/userSlice'; // Adjust the path based on your file structure
    ...
    <>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="card bg-base-100 w-96 shadow-xl p-5">
          ...
          <div className="mb-4">
            <label class="input input-bordered flex items-center gap-2">
              Username
              <input type="text" className="grow" onChange={(e) => setUsername(e.target.value)} />
            </label>
          </div>
          <div className="mb-4">
            <label class="input input-bordered flex items-center gap-2">
      ...
      <div className="flex items-center justify-center min-h-screen">
        <div className="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl">
          <div className="hidden lg:flex bg-cover lg:w-1/2 lg:justify-center lg:items-center">
            <Image
              src={'/login.png'}
              alt="Hero"
              width={1460}
          ...
          <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className="mt-4">
                ...
                <input id="LoggingEmailAddress" onChange={(e) => setUsername(e.target.value)} className="block w-full px-4 py-2 text-gray-700 bg-white border rounded-lg dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-gray-400 focus:ring-opacity-40 dark:focus:border-gray-300 focus:outline-none focus:ring focus:ring-gray-300" type="text" />
              </div>
              ...
              <div className="mt-4">
                ...
                <input id="loggingPassword" onChange={(e) => setPassword(e.target.value)} className="block w-full px-4 py-2 text-gray-700 bg-white border rounded-lg dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-gray-400 focus:ring-opacity-40 dark:focus:border-gray-300 focus:outline-none focus:ring focus:ring-gray-300" type="password" />
              </div>
              {error && <p className="text-red-500 mb-4">{error}</p>}
